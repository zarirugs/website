      ...
      <Container>
        <FadeIn>
          <div className="max-w-xl">
            <Eyebrow className="mb-8">Our Ethos</Eyebrow>
            <Heading as="h2" size="xl">
              {philosophy.title}
            </Heading>

            <Text size="lg" className="mt-12 text-neutral-500 leading-loose">
        ...
        >
          {philosophy.values.map((value) => (
            <div key={value.title} className="border-t border-neutral-300/60 pt-10">
              <Heading as="h3" size="md">
                {value.title}
              </Heading>
              <Text className="mt-6 text-sm leading-loose text-neutral-500">
                {value.description}
              </Text>
            </div>
          ))}
