...
type CurrentProduct = { sku: string; stock: number; category_id: string | null; category_name: string | null; description: string | null; image_url: string | null; media_asset_id: string | null; price_paise: number | null; is_visible: number | null; sort_order: number | null };
